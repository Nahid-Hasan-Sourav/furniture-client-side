    ...
    <div className="bg-base-200">
      <footer >
        ...
        <div>
          ...
          <p className="my-2">By completing this form you're signing up to receive our emails and can<br/> unsubscribe at any time</p>
        </div>
        </div>
        ...
        <div className="grid grid-cols-2">
            <div className="flex">
                <p className="mr-5"><FaFacebookF /></p>
                <p className="mr-5"><BsTwitter /></p>
                <p className="mr-5"><AiFillInstagram /></p>
            </div>
            <div>
