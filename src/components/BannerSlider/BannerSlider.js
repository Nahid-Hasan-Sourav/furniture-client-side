                        ...
                        return (
                          <SwiperSlide>
                            ...
                            <div className="text ml-[140px]">
                                ...
                                <p className="transform -rotate-90 bg-black p-2 left-[10.19%] absolute z-10 top-[56%] text-white font-extrabold">UP TO</p>
                                <div className="">
                                  <h1 className="absolute z-10 top-[50%] text-white font-Inter font-extrabold font- text-8xl pl-14">{data.discount}</h1>
